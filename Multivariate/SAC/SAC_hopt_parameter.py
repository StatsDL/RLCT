...
def objective(params):
    ...
    Reward = (model.critic_criterion(Val_actions1, torch.tensor(val_y[:,0].reshape(val_y.shape[0],1))) + model.critic_criterion(Val_actions2, torch.tensor(val_y[:,1].reshape(val_y.shape[0],1))))/2
    print(Reward)
    return Reward.item()
...
# datasets = ['DJI', 'Bitcoin', 'EURUSD', 'GBPUSD', 'Gold']
datasets = ['EURUSD', 'GBPUSD', 'CNYUSD', 'CADUSD', 'AUDUSD']
